...
﻿namespace Site.NotificationService
{
    ...
    public class UsernamePasswordSampleNotificationServiceFactory : VenusServiceFactoryBase<NotificationService>
    {
        public UsernamePasswordSampleNotificationServiceFactory() { }
        ...
        public override void SecureServiceHost(ServiceHost serviceHost, Uri[] baseAddresses)
        {
            ...
            wifServiceConfiguration.SecurityTokenHandlers.Add(new DemoUserNamePasswordNotificationServiceSecurityTokenHandler());
    ...
    public class DemoUserNamePasswordNotificationServiceSecurityTokenHandler : Microsoft.IdentityModel.Tokens.UserNameSecurityTokenHandler
    {
        public DemoUserNamePasswordNotificationServiceSecurityTokenHandler() { }
