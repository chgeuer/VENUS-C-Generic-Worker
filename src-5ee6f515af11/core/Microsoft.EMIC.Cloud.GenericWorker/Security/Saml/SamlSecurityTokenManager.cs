...
namespace Microsoft.EMIC.Cloud.Security.Saml
{
    ...
    public class SamlSecurityTokenManager : ClientCredentialsSecurityTokenManager
    {
        ...
        /// </summary>
        readonly SamlClientCredentials samlClientCredentials;
                ...
                if (assertion == null || prooftoken == null)
                {
                    ...
                    if (tokenRequirement.KeyType == SecurityKeyType.SymmetricKey)
                    {
                        ...
                        assertion = SamlUtilities.CreateSymmetricKeyBasedAssertion(this.samlClientCredentials.Claims,
                                                                               ...
                                                                               sas,
                                                                               this.samlClientCredentials.Audience);
                    }
                    // otherwise...
                    else
                    {
                        ...
                        // and a corresponding assertion based on the claims specified in the client credentials
                        assertion = SamlUtilities.CreateAsymmetricKeyBasedAssertion(this.samlClientCredentials.Claims, prooftoken, sas, this.samlClientCredentials.Audience);
                    }

                }

                // Create a SamlSecurityTokenProvider based on the assertion and proof token
                return new SamlSecurityTokenProvider(assertion, prooftoken, samlClientCredentials.ServiceCertificate.DefaultCertificate);
            }
