...
﻿namespace Site.SubmissionService
{
    ...
    public class UsernamePasswordSampleSubmissionServiceFactory : VenusServiceFactoryBase<BESFactoryPortTypeImplService>
    {
        public UsernamePasswordSampleSubmissionServiceFactory() { }
        ...
        public override void SecureServiceHost(ServiceHost serviceHost, Uri[] baseAddresses)
        {
            ...
            wifServiceConfiguration.SecurityTokenHandlers.Add(new DemoUserNamePasswordJobSubmissionSecurityTokenHandler());
    ...
    public class DemoUserNamePasswordJobSubmissionSecurityTokenHandler : Microsoft.IdentityModel.Tokens.UserNameSecurityTokenHandler
    {
        public DemoUserNamePasswordJobSubmissionSecurityTokenHandler() { }
        ...
        public override ClaimsIdentityCollection ValidateToken(SecurityToken token)
        {
            ...
            claimsId.Claims.Add(VenusClaimsAuthorizationManager.Roles.Researcher);
