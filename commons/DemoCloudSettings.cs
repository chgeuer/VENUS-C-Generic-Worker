...
namespace Microsoft.EMIC.Cloud.Demo
{
    ...
    internal static class CloudSettings
    {
        private static HostSwitch HostSwitch
        {
            get
            {
                var x = GetRegistryValue("Microsoft.EMIC.Cloud.Development.Host.Switch");
                var res = (HostSwitch)Enum.Parse(typeof(HostSwitch), x);
                return res;
            }
        }
        ...
        [Export(CompositionIdentifiers.DemoUserConnectionString)]
        public static string UserDataStoreConnectionString { get { return GetSettingValue(CompositionIdentifiers.DemoUserConnectionString); } }
        ...
        public static string GenericWorkerUrl { get { return GetHostName(CloudSettings.HostSwitch, "/JobSubmission/Service.svc"); } }

        [Export(CompositionIdentifiers.ScalingServiceURL)]
        public static string ScalingServiceUrl { get { return GetHostName(CloudSettings.HostSwitch, "/ScalingService/Service.svc"); } }

        [Export(CompositionIdentifiers.NotificationServiceURL)]
        public static string NotificationServiceURL { get { return GetHostName(CloudSettings.HostSwitch, "/NotificationService/Service.svc"); } }

        [Export(CompositionIdentifiers.STSURL)]
        public static string CorporateSTSUrl { get { return GetHostName(CloudSettings.HostSwitch, "/STS/UsernamePassword.svc"); } }

        /// <summary>
        /// Gets the corporate secured job management URL.
        /// </summary>
        [Export(CompositionIdentifiers.SecuredJobManagementSiteURL)]
        public static string SecuredJobManagementSiteURL { get { return GetHostName(CloudSettings.HostSwitch, "/JobManagement/"); } }
